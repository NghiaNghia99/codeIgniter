  ...
  <div class="top-content">
    ...
    <div class="sm-menu-tab">
      <ul class="menu-post-detail">
        ...
        <a class="menu-edit active" href="<?= base_url('auth/content/poster/edit/' . $post['id']) ?>">
          Edit
        </a>
      ...
      <form method="post">
        <div class="form-item">
          ...
          <input type="text" class="input input-custom" name="title" placeholder="Title"
                 value="<?php echo set_value('title', $post['posterTitle']) ?>"/>
        ...
        <div class="form-item">
          ...
          <input type="text" class="input input-custom" name="affiliation"
                 ...
                 value="<?php echo set_value('affiliation', $post['posterAffiliation']) ?>">
        ...
        <div class="form-item">
          ...
          <textarea class="input textarea-custom" name="caption" placeholder="Short description of poster (3000 char max)"><?php echo set_value('caption',
        ...
        <div class="form-item gr-button">
          ...
          <div class="d-flex">
            ...
            <button type="button" class="btn-custom btn-bg gray btn-cancel btn-redirect" data-link="<?= base_url('auth/content/poster/' . $post['id']) ?>">
              Cancel
            </button>
          </div>
        </div>
