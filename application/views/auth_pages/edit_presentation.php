  ...
  <div class="top-content">
    ...
    <div class="sm-menu-tab">
      <ul class="menu-post-detail">
        ...
        <a class="menu-edit active" href="<?= base_url('auth/content/presentation/edit/' . $post['id']) ?>">
          Edit
        </a>
        <a class="menu-request-doi" href="<?= base_url('auth/content/presentation/request-doi/' . $post['id']) ?>">
          Request DOI
        </a>
      ...
      <form method="post">
        <div class="form-item">
          ...
          <input type="text" class="input input-custom" name="title" placeholder="Title"
                 value="<?php echo set_value('title', $post['presTitle']) ?>"/>
        ...
        <div class="form-item">
          ...
          <input type="text" class="input input-custom" name="affiliation"
                 ...
                 value="<?php echo set_value('affiliation', $post['presAffiliation']) ?>">
        ...
        <div class="form-item">
          ...
          <textarea class="input textarea-custom" name="caption" placeholder="Short description of presentation (3000 char max)"><?php echo set_value('caption',
        ...
        <div class="form-item gr-button">
          ...
          <div class="d-flex">
            ...
            <button type="button" class="btn-custom btn-bg gray btn-cancel btn-redirect" data-link="<?= base_url('auth/content/presentation/' . $post['id']) ?>">
              Cancel
            </button>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content sm-modal-content">
      ...
      <div class="sm-modal-footer d-none">
        <input type="hidden" class="get-id-post" value="<?= $post['id'] ?>">
        <button class="btn-custom btn-bg green btn-delete btn-delete-presentation-confirm" data-dismiss="modal">Delete presentation</button>
      </div>
    </div>
  </div>
</div>
