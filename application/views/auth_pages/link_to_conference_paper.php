...
<div class="section-post-page content-wrapper">
    ...
    <div class="sm-menu-tab">
      <ul class="menu-post-detail">
        ...
        <a class="menu-link-to-conference active" href="<?= base_url('auth/content/paper/link-to-conference/' . $post['id']) ?>">
          Link to conference
        </a>
      </ul>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content sm-modal-content">
      ...
      <div class="sm-modal-footer d-none">
        <input type="hidden" class="get-id-post" value="<?= $post['id'] ?>">
        <button class="add-spinner btn-custom btn-bg green btn-delete btn-delete-paper-confirm" data-dismiss="modal">Delete paper</button>
      </div>
    </div>
  </div>
</div>
