...
<div class="section-object-list layout-list-sort">
  <div class="section-object-list-title">Shared papers</div>
  <div class="section-object-list-content results">
    <nav>
      <div class="nav nav-tabs" id="nav-tab-paper-list" role="tablist">
        <a class="nav-item nav-link active" id="nav-paper-list-tab" data-toggle="tab" href="#nav-paper-list" role="tab" aria-controls="nav-paper-list" aria-selected="true">Paper list</a>
      </div>
    </nav>
    <div class="tab-content" id="nav-tabPaperList">
      <div class="results-list tab-pane fade show active" id="nav-paper-list" role="tabpanel" aria-labelledby="nav-paper-list-tab">
          <?php if (!empty($posts)) : ?>
                  ...
                  <div class="post-item-custom width-370">
                    <div class="front-item">
                      ...
                      <div class="post-item-custom-content">
                        <div class="post-item-custom-content-title"><?= $result->paperTitle ?></div>
                    ...
                    <div class="post-item-custom-detail block-white back-item">
                      ...
                      <div class="btn-custom btn-border green">
                        <a href="<?= base_url('auth/content/paper/' . $result->id); ?>">View more</a>
                      </div>
                    </div>
                  </div>
                <?php endforeach; ?>
          ...
          <?php else : ?>
            <div class="list-none-item">
              <p>You have not uploaded any papers yet.</p>
              <a class="link" href="<?= base_url('auth/content/paper/upload') ?>">Upload your first paper here.</a>
            </div>
          <?php endif; ?>
      </div>
    </div>
