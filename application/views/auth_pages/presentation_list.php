...
<div class="section-object-list layout-list-sort">
  <div class="section-object-list-title">Shared presentations</div>
  <div class="section-object-list-content results">
    <nav>
      <div class="nav nav-tabs" id="nav-tab-video-list" role="tablist">
        <a class="nav-item nav-link active" id="nav-presentation-list-tab" data-toggle="tab" href="#nav-presentation-list" role="tab" aria-controls="nav-presentation-list" aria-selected="true">Presentation list</a>
      </div>
    </nav>
    <div class="tab-content" id="nav-tabPresentationList">
      <div class="results-list tab-pane fade show active" id="nav-presentation-list" role="tabpanel" aria-labelledby="nav-presentation-list-tab">
          <?php if (!empty($posts)) : ?>
                  ...
                  <div class="post-item-custom width-370">
                    <div class="front-item">
                      ...
                      <div class="post-item-custom-content">
                        <div class="post-item-custom-content-title"><?= $result->presTitle ?></div>
                    ...
                    <div class="post-item-custom-detail block-white back-item">
                      ...
                      <div class="btn-custom btn-border green">
                        <a href="<?= base_url('auth/content/presentation/' . $result->id); ?>">View more</a>
                      </div>
                    </div>
                  </div>
                <?php endforeach; ?>
          ...
          <?php else : ?>
            <div class="list-none-item">
              <p>You have not uploaded any presentations yet.</p>
              <a class="link" href="<?= base_url('auth/content/presentation/upload') ?>">Upload your first presentation here.</a>
            </div>
          <?php endif; ?>
      </div>
    </div>
