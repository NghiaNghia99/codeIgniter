<div class="section-post-page content-wrapper">
    ...
    <div class="sm-menu-tab">
      <ul class="menu-post-detail">
        ...
        <a class="menu-request-doi active" href="<?= base_url('auth/content/poster/request-doi/' . $post['id']) ?>">
          Request DOI
        </a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content sm-modal-content">
      ...
      <div class="sm-modal-footer d-none">
        <input type="hidden" class="get-id-post" value="<?= $post['id'] ?>">
        <button class="add-spinner btn-custom btn-bg green btn-delete btn-delete-poster-confirm" data-dismiss="modal">Delete poster</button>
      </div>
    </div>
  </div>
</div>
