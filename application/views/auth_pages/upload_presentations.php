...
<div class="content-wrapper content-upload">
  <form id="uploadContentForm" method="post" enctype="multipart/form-data">
    ...
    <div class="form-item">
      ...
      <input type="text" id="title" class="input input-custom countCharacters" name="title"
             placeholder="Title"
    ...
    <div class="form-item">
      ...
      <input type="text" id="affiliation" class="input input-custom countCharacters" name="affiliation"
             placeholder="Affiliation connected with the presentation"
    ...
    <div class="form-item">
      ...
      <textarea type="text" id="caption" class="input-custom textarea-custom countCharacters" name="caption"
                placeholder="Short description of presentation (1000 chars max)"><?php echo set_value('caption') ?></textarea>
    ...
    <div class="form-item">
      ...
      <input type="text" id="coAuthors" class="input input-custom countCharacters" name="co_authors" placeholder="Co-authors if any"
    ...
    <div class="form-item">
      ...
      <textarea id="furtherReading" class="input-custom textarea-custom countCharacters" name="further_reading"
    ...
    <div class="form-item">
      ...
      <select id="language" name="language" class="input-custom select-custom">
          <?php
    ...
    <!-- <div class="form-item">
      ...
      <textarea class="input textarea-custom countCharacters" name="additional_information"
                placeholder="Additional information about the presentation"><?php echo set_value('additional_information') ?></textarea>
    ...
    <div class="required-field">
      ...
      <div class="block-file-upload">
        ...
        <div class="form-label label-custom">
          Presentation file (pdf, ppt, pptx, odp)
          <span class="req">*</span>
        </div>
    ...
    <div id="video_upload_btn" class="button-bottom d-none">
      <input type="button" id="submitUploadContentForm" data-type="presentation" class="btn-custom btn-bg green btn-upload ml-auto" value="Upload" name="submit">
    </div>
      <?php if ($this->session->flashdata('upload_post_msg')) : ?>
        <div class="button-bottom btn-reset">
          <a href="<?= base_url('auth/content/presentation/upload') ?>" class="add-spinner btn-custom no-child btn-bg green btn-upload ml-auto">Reset</a>
        </div>
      <?php endif; ?>
    <div class="sm-text-item">
      <div class="title-sm-text-item">
        Uploaded presentations this session
      </div>
      <div class="content-sm-text-item">
        The following list contains thumbnail images of your uploaded presentations in this session.
      </div>
    </div>
    <div class="sm-table-item">
      <div class="title-sm-table-item">
        Presentations in your job list
      </div>
      <table class="table table-custom table-preview-upload">
        ...
        <tbody>
        <?php
        $list_post = $this->session->upload_presentation;
        if (!empty($list_post)):
...
<?php else: ?>
  <div class="block-white-p40-100">
    <p>You had failed to upload this presentation due to our terms and conditions. Please upload a new presentation or contact our team for more information.</p>
    <a class="link mt-2" href="<?= base_url('auth/content/presentation/upload') ?>">Upload a new presentation here.</a>
  </div>
<?php endif; ?>