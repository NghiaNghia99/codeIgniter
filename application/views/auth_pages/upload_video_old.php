...
<div class="content-wrapper content-upload">
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="form-item">
      ...
      <input type="text" class="input input-custom countCharacters" name="video_title"
             placeholder="Title"
    ...
    <div class="form-item">
      ...
      <input type="text" class="input input-custom countCharacters" name="video_affiliation"
    ...
    <div class="form-item">
      ...
      <textarea type="text" class="input-custom textarea-custom countCharacters" name="video_caption"
    ...
    <div class="form-item">
      ...
      <input type="text" class="input input-custom countCharacters" name="video_co_authors"
    ...
    <div class="form-item">
      ...
      <textarea class="input-custom textarea-custom countCharacters" name="video_further_reading"
    ...
    <div class="form-item">
      ...
      <select name="video_language" class="input-custom select-custom">
          <?php
    ...
    <div class="form-item">
      ...
      <textarea class="input textarea-custom countCharacters" name="video_additional_information"
