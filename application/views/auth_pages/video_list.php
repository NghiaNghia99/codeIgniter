  ...
  <div class="section-object-list-content results">
    <nav>
      <div class="nav nav-tabs" id="nav-tab-video-list">
        <a class="nav-item nav-link tab-item active" id="nav-video-list-tab" data-toggle="tab" href="#nav-video-list" role="tab" aria-controls="nav-video-list" aria-selected="true">Video list</a>
        <a class="nav-item nav-link tab-item" id="nav-upload-queue-tab" href="<?= base_url('auth/content/videos/queue') ?>">Upload queue</a>
      </div>
    </nav>
    <div class="tab-content" id="nav-tabVideoList">
      <div class="results-list tab-pane fade show active" id="nav-video-list">
          <?php if (!empty($posts)) : ?>
                  ...
                  <div class="post-item-custom width-370">
                    <div class="front-item">
                      ...
                      <div class="post-item-custom-content">
                        <div class="post-item-custom-content-title"><?= $result->title ?></div>
                    ...
                    <div class="post-item-custom-detail block-white back-item">
                      ...
                      <div class="btn-custom btn-border green">
                        <a href="<?= base_url('auth/content/video/' . $result->id); ?>">View more</a>
                      </div>
                    </div>
                  </div>
                <?php endforeach; ?>
          ...
          <?php else : ?>
            <div class="list-none-item">
              ...
              <a class="link" href="<?= base_url('auth/content/video/upload') ?>">Upload your first video here.</a>
            </div>
          <?php endif; ?>
      </div>
    </div>
