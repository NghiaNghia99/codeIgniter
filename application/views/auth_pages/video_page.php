  ...
  <div class="top-content">
    ...
    <div class="sm-menu-tab">
      <ul class="menu-post-detail">
        <a class="menu-view active" href="<?= base_url('auth/content/video/' . $post['id']) ?>">
          Video
        </a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content sm-modal-content">
      ...
      <div class="sm-modal-footer d-none">
        <input type="hidden" class="get-id-post" value="<?= $post['id'] ?>">
        <button class="add-spinner btn-custom btn-bg green btn-delete btn-delete-video-confirm" data-dismiss="modal">Delete video</button>
      </div>
    </div>
  </div>
</div>
