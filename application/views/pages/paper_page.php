    ...
    <div class="block-white">
      <div class="scroll-x">
        <div class="navigation-list">
          ...
          <div class="navigation-list-item"><?= $post['paperTitle'] ?></div>
        </div>
      </div>
      ...
      <div class="post-page-info">
        ...
        <div class="content-item">
          ...
          <div class="report-post-item">
            If the paper contains inappropriate content, please <a class="link" href="<?= base_url('report/' . 'paper/' . $post['id']) ?>">report</a> the paper. You will be redirected to the landing page.
          </div>
          ...
          <?php if ($checkAuthor): ?>
            <div class="edit-add-to-conference">
              <div class="btn-custom btn-border green special">
                <a href="<?= base_url('auth/content/paper/edit/' . $post['id']) ?>">Edit Paper</a>
              </div>
              <div class="btn-custom btn-border green special">
                <a href="<?= base_url('auth/content/paper/link-to-conference/' . $post['id']) ?>">Add to conference</a>
              </div>
            </div>
          <?php endif;?>
      </div>
