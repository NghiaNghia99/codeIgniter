    ...
    <div class="block-white">
      <div class="scroll-x">
        <div class="navigation-list">
          ...
          <div class="navigation-list-item"><?= $post['posterTitle'] ?></div>
        </div>
      </div>
      ...
      <div class="post-page-info">
        ...
        <div class="content-item">
          ...
          <div class="report-post-item">
            If the poster contains inappropriate content, please <a class="link" href="<?= base_url('report/' . 'poster/' . $post['id']) ?>">report</a> the poster. You will be redirected to the landing page.
          </div>
          ...
          <?php if ($checkAuthor): ?>
            <div class="edit-add-to-conference">
              <div class="btn-custom btn-border green special">
                <a href="<?= base_url('auth/content/poster/edit/' . $post['id']) ?>">Edit Poster</a>
              </div>
              <div class="btn-custom btn-border green special">
                <a href="<?= base_url('auth/content/poster/link-to-conference/' . $post['id']) ?>">Add to conference</a>
              </div>
            </div>
          <?php endif;?>
      </div>
