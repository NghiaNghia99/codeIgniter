<div class="section-search layout-list-sort">
  <div class="container">
    <div class="layout-list-sort-content">
      <div class="layout-list-sort-content-left">
        <div class="sidebar">
          <div class="sidebar-title">Search results</div>
          <div class="sidebar-item active mobile-item" id="show_search_menu">
            <span class="sidebar-item-text"><?= $postType ?></span>
            <span class="quantity-number <?php
            if ($postType == 'videos') {
                echo 'videos';
          ...
          <div class="tab-content" id="search_results_tabContent">
            <div class="results-list tab-pane face <?php if ($postType == 'conferences') {
                ...
                <?php if (!empty($conferences)) : ?>
                  <div class="results-title">Search results for<span><?= $key ?></span></div>
                  <div class="sort desktop-item">
                    <div class="sort-item">
                      ...
                      <div class="dropdown dropdown-sort-custom dropdown-mobile-custom">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownSortView">
                          <a
                            class="dropdown-item sort-item-content get-sort-search <?php if ($active_sort == 'Max') {
                                echo ' active-custom';
                            } ?>">Max</a>
                          <a
                            class="dropdown-item sort-item-content get-sort-search <?php if ($active_sort == 'Min') {
                                echo ' active-custom';
                            } ?>">Min</a>
                        </div>
                      </div>
                    ...
                    <div class="sort-item">
                      ...
                      <div class="dropdown dropdown-sort-custom dropdown-mobile-custom">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownSortView">
                          <a
                            class="dropdown-item sort-item-content get-sort-search <?php if ($active_sort == 'Youngest') {
                                echo ' active-custom';
                            } ?>">Youngest</a>
                          <a
                            class="dropdown-item sort-item-content get-sort-search <?php if ($active_sort == 'Oldest') {
                                echo ' active-custom';
                            } ?>">Oldest</a>
                        </div>
                      </div>
                    ...
                    <div class="sort-item">
                      ...
                      <div class="dropdown dropdown-sort-custom dropdown-mobile-custom">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownSortView">
                          <a
                            class="dropdown-item sort-item-content get-sort-search <?php if ($active_sort == 'A-Z') {
                                echo ' active-custom';
                            } ?>">A-Z</a>
                          <a
                            class="dropdown-item sort-item-content get-sort-search <?php if ($active_sort == 'Z-A') {
                                echo ' active-custom';
                            } ?>">Z-A</a>
                        </div>
                      </div>
                    ...
                    <div class="results-title">Search results for<span><?= $key ?></span></div>
                      <?php if ($countVideo > 0 || $countPresentation > 0 || $countPoster > 0 || $countPaper > 0): ?>
                        <p>Results were found under
                            ...
                            if ($countVideo > 0 && ($countPresentation || $countPoster || $countPaper)){
                                echo ',';
                            }
                            if ($countPresentation > 0){
                                echo ' presentations';
                            }
                            if ($countPresentation > 0 && ($countPoster || $countPaper)){
                                echo ',';
                            }
                            if ($countPoster > 0){
                                echo ' posters';
                          ...
                          .</p>
                      <?php else: ?>
                        <p>We are sorry! Your search parameters yielded no results for conferences. Try again!</p>
                      <?php endif; ?>
                  </div>
                <?php endif; ?>
            </div>
            <div class="results-list tab-pane face <?php if ($postType == 'videos') {
                ...
                <?php else : ?>
                  <div class="search-none-item">
                    <div class="results-title">Search results for<span><?= $key ?></span></div>
                    <p>We are sorry! Your search parameters yielded no results for videos. Try again!</p>
                  </div>
                <?php endif; ?>
            </div>
            <div class="results-list tab-pane face <?php if ($postType == 'presentations') {
                ...
                <?php else : ?>
                  <div class="search-none-item">
                    <div class="results-title">Search results for<span><?= $key ?></span></div>
                    <p>We are sorry! Your search parameters yielded no results for presentations. Try again!</p>
                  </div>
                <?php endif; ?>
            </div>
            <div class="results-list tab-pane face <?php if ($postType == 'posters') {
                ...
                <?php else : ?>
                  <div class="search-none-item">
                    <div class="results-title">Search results for<span><?= $key ?></span></div>
                    <p>We are sorry! Your search parameters yielded no results for posters. Try again!</p>
                  </div>
                <?php endif; ?>
            </div>
            <div class="results-list tab-pane face <?php if ($postType == 'papers') {
                ...
                <?php else : ?>
                  <div class="search-none-item">
                    <div class="results-title">Search results for<span><?= $key ?></span></div>
                    <p>We are sorry! Your search parameters yielded no results for papers. Try again!</p>
                  </div>
                <?php endif; ?>
            </div>
          </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="sort-item">
                        ...
                        <div class="checkbox-custom">
                            <input type="radio" class="input get-sort-search" name="sort-views"
                    ...
                    <div class="sort-item">
                        ...
                        <div class="checkbox-custom">
                            <input type="radio" class="input get-sort-search" name="sort-date"
                    ...
                    <div class="sort-item">
                        ...
                        <div class="checkbox-custom">
                            <input type="radio" class="input get-sort-search" name="sort-alpha"
