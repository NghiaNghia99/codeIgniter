    ...
    */
    ...
    var SimpleDayGridEventRenderer = /** @class */ (function (_super) {
        ...
        SimpleDayGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
            ...
            var test = eventRange.def.extendedProps;
            ...
            var timeText;
            var titleHtml;
            classes.unshift('fc-day-grid-event', 'fc-h-event', 'dot ' + test.type.toLowerCase().replace(' ', '') + '-dot');
            ...
            titleHtml =
                '<span class="fc-title" data-id="'+eventDef.idtask+'">' +
